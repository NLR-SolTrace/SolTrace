...
public slots:
    ...
    SolTrace::GUI::Data::Entity material_of_group();

    /// Geometry group represented by this instancing adapter.
    SolTrace::GUI::Data::Entity geometry_of_group();

    /// Material group assigned to the instance at index.
    SolTrace::GUI::Data::Entity material_of(int index);

    /// Geometry group assigned to the instance at index.
    SolTrace::GUI::Data::Entity geometry_of(int index);

    /// Entity represented by the instance at index.
    SolTrace::GUI::Data::Entity at(int index);
