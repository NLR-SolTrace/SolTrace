...
void MaterialGroupsModel::group_changed(SolTrace::GUI::Data::Entity e) {
    if (!m_host) return;
...
void MaterialGroupsModel::group_removed(SolTrace::GUI::Data::Entity e) {
    qDebug() << Q_FUNC_INFO << SolTrace::GUI::Data::Entity(e);
    recompute();
}
...
int MaterialGroupsModel::index_of(SolTrace::GUI::Data::Entity entity) const {
...
void GeometryGroupsModel::group_changed(SolTrace::GUI::Data::Entity e) {
    if (!m_host) return;
...
void GeometryGroupsModel::group_removed(SolTrace::GUI::Data::Entity e) {
    recompute();
}
...
int GeometryGroupsModel::index_of(SolTrace::GUI::Data::Entity entity) const {
    auto iter = m_reverse.find(entity);
    if (iter == m_reverse.end()) return -1;
    return iter->second;
}
...
void TagsModel::tag_changed(SolTrace::GUI::Data::Entity e) {
    if (!m_host) return;
...
void TagsModel::tag_removed(SolTrace::GUI::Data::Entity e) {
    recompute();
}
