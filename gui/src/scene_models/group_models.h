...
private slots:
    ...
    void group_changed(SolTrace::GUI::Data::Entity);
    void group_removed(SolTrace::GUI::Data::Entity);
...
private slots:
    ...
    void tag_changed(SolTrace::GUI::Data::Entity);
    void tag_removed(SolTrace::GUI::Data::Entity);
