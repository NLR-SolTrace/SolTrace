...
bool MaterialComponent::operator==(SolTrace::GUI::Data::MaterialComponent const& b) const {
...
bool GeometryComponent::operator==(SolTrace::GUI::Data::GeometryComponent const& b) const {
