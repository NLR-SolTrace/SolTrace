...
namespace std {
template <>
/// Allow SolTrace::GUI::Data::Entity keys in unordered containers.
struct hash<SolTrace::GUI::Data::Entity> {
    std::size_t operator()(SolTrace::GUI::Data::Entity e) const noexcept {
